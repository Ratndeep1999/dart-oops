...
void main() {
  ...
  print('Circle area: ${circle.area}'); // Circle area: 314.0
  print('Rectangle area: ${rectangle.area}'); // Rectangle area: 200.0

  // create a list of Shape objects
  var region = Region(shapes: [circle, rectangle]);
  // print the total area
  print("Total Area of Region: ${region.totalArea}"); // Total Area of Region: 514.0
}