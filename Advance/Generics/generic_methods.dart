...
/// Example of Generic method with a single parameter
T printValue<T>(T value) {
  print(value);
  return value;
}

/// Example of Generic method with multiple type parameters
...
void main() {
  ...
  /// Single parameters generic method
  printValue<int>(10); // 10
  printValue<String>("Dart"); // Dart
  printValue<double>(3.14); // 3.14

  /// Multiple type parameters
  printMultiValues<int, String>(26, "Ratndeep",); // value1: 26 & value2: Ratndeep
